...
angular.module("com.2fdevs.videogular.plugins.overlayplay", [])
        .run(
                ["$templateCache", function ($templateCache) {
                  ...
                  <div class="iconButton iconButtonPlay" ng-class="overlayPlayIcon"></div>\
				  <div class="iconButton iconButtonPause pause hide" ng-class="overlayPauseIcon"></div>\
                </div>');
                    }]
                )
                        ...
                        scope.onChangeState = function onChangeState(newState) {
                            ...
                            switch (newState) {
                                case VG_STATES.PLAY:
                                    ...
                                    $(".iconButtonPause").removeClass('hide');
                                    $(".iconButtonPlay").addClass('hide');
                                    setTimeout(function () {
                                        $(".iconButtonPause").addClass('hide');
                                    }, 4000);
                                    break;
                                ...
                                case VG_STATES.PAUSE:
                                    ...
                                    $(".iconButtonPause").addClass('hide');
                                    $(".iconButtonPlay").removeClass('hide');
                                    break;
