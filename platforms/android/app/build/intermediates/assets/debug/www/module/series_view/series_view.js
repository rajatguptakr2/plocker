app.controller('series_view', function ($scope, $http, $location, $rootScope, $cookieStore, $cordovaFile, $cordovaFileTransfer, $timeout, loading, model) {
    ...
    if ($cookieStore.get('detail')) {
        if ($cookieStore.get('detail').type == 'series' || $cookieStore.get('detail').type == 'series') {
            var res = "";
            loading.active();
            ...
            $http({
                ...
                if (res.data.responseCode == '200') {
                    ...
                    $rootScope.movie_data = $scope.movie_data = res.data.data;
            ...
            $http({
                ...
                if (res.data.responseCode == '200') {
                    ...
                    var movie_detail = {
                        ...
                        series_id: $cookieStore.get('detail').series_id,
